...
export class init1610466679611 implements MigrationInterface {
    name = 'init1610466679611'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "order" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "state" varchar NOT NULL, "approveDate" datetime, "phone_number" varchar NOT NULL)`);
